...
% The Baseload_Umass_homeG_15min.m is used for load decomposition of residential customer in Western Massachusetts,USA
%% load data¡ª¡ªUmass 1st,Jan,2016--31st,Dec,2016

load HomeGdata15min.mat
...
hold on
plot(air7_new(140*2:240*2,1),'k-','LineWidth',1);
hold on
plot(air7_es_new(140*2:240*2,1),'r-.','LineWidth',1);
set(gca,'FontName','Times New Roman','FontSize',4)
ylabel('\fontsize{4}\fontname{Times new roman}ACLs (kW)')
xlim([0 100])
set(gca,'xtick',[140*2:40:240*2])
set(gca,'xticklabel',{'280','320','360','400','440','480'})
