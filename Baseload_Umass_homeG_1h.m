...
% The Baseload_Umass_homeG_1h.m is used for load decomposition of residential customer in Western Massachusetts,USA
%% load data¡ª¡ªUmass 1st,Jan,2016--31st,Dec,2016

load HomeGdata1h.mat
...
set(gca,'FontName','Times New Roman','FontSize',8)
ylabel('\fontsize{8}\fontname{Times new roman}ACLs (kW)')
xlabel('\fontsize{8}\fontname{Times new roman}Time (1h)')
ylim([0 1.5])
xlim([0 180])
hold on
axes('position',[0.2,0.7,0.4,0.2]);
hold on
plot(air7_new(70:120,1),'k-','LineWidth',1);
hold on
plot(air7_es_new(70:120,1),'r-.','LineWidth',1);
set(gca,'FontName','Times New Roman','FontSize',4)
ylabel('\fontsize{4}\fontname{Times new roman}ACLs (kW)')
xlim([0 50])
set(gca,'xtick',[70:10:120])
set(gca,'xticklabel',{'70','80','90','100','110','120'})